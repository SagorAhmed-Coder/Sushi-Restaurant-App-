      ...
      body: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
               Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   Text('Get 46% promo',style: GoogleFonts.dmSerifDisplay(
                     color: Colors.white,
                     fontSize: 30,
                   ),),
          ...
          Padding(
            ...
            child: Text('Food Menu',style:GoogleFonts.aBeeZee(
              fontSize: 26,
            ),),
          ),
          Consumer<Shop>(
            builder: (context,value,child) {
              return SizedBox(
                ...
                return FoodTile(oneFood: oneFood);
                },
                ),
              );
            }
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Favourite',style: GoogleFonts.aBeeZee(
                  fontSize: 26,
                ),),
                  ...
                  itemBuilder: (context, index) {
                    Food twoFood = food[index];
                     return Container(
                       ...
                       margin: EdgeInsets.only(left: 13,right: 13,bottom: 15),
                       padding: EdgeInsets.all(20),
                       child: Row(
                         children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(twoFood.name,style: GoogleFonts.aBeeZee(
                                  fontSize: 22,
                                ),),
                                Text("\$${twoFood.price}",style: TextStyle(fontWeight: FontWeight.w600,color: Colors.grey[600]),),
                              ],
                            ),
                           Spacer(),
                           Container(
